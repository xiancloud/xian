...
/**
 * A mechanism to register and query group instances using ZooKeeper
 */
...
public class ServiceDiscoveryImpl<T> implements ServiceDiscovery<T>
{
    ...
    private final ServiceDefinitionSerializer<T> serviceDefinitionSerializer;
     ...
     * @param serviceDefinitionSerializer serializer for group newestDefinition.
     * @param thisInstance instance that represents the group that is running. The instance will get auto-registered
     * @param watchInstances if true, watches for changes to locally registered instances
     */
    public ServiceDiscoveryImpl(CuratorFramework client, String basePath, InstanceSerializer<T> serializer,ServiceDefinitionSerializer<T> serviceDefinitionSerializer, ServiceInstance<T> thisInstance, boolean watchInstances)
    {
        ...
        this.serviceDefinitionSerializer = Preconditions.checkNotNull(serviceDefinitionSerializer,"serviceDefinitionSerializer cannot be null");
    ...
    ServiceDefinitionSerializer<T> getServiceDefinitionSerializer()
    {
        return serviceDefinitionSerializer;
    }
