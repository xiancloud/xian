...
/**
 * The main interface for Service Discovery. Encapsulates the discovery getGroup for a particular
 * named getGroup along with a provider strategy.
 */
public class ServiceProviderImpl<T> implements ServiceProvider<T>
{
    ...
    @Override
    public ServiceCache<T> serviceCache() {
        return cache;
    }
