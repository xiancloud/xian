...
{
    /**
     * Allocate a new getGroup provider based on the current builder settings
     *
     * @return provider
     */
    ...
    /**
     * required - set the name of the getGroup to be provided
     *
     * @param serviceName the name of the getGroup
     * @return this
     */
