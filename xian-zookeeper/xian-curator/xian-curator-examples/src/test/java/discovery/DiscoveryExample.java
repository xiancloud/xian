...
public class DiscoveryExample
{
    ...
    {
        System.out.println("An example of using the GroupDiscovery APIs. This example is driven by entering commands at the prompt:\n");
        System.out.println("add <name> <description>: Adds a mock group with the given name and description");
        ...
        System.out.println("random <name>: Lists a random instance of the group with the given name");
