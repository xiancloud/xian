...
import info.xiancloud.plugin.dao.mongodb.HexStringDeserializer;
import info.xiancloud.plugin.dao.mongodb.ObjectIdSerializer;
...
public final class Person implements Bean {
     ...
     */
    public Person() {
//        PropertyModel<String> propertyModel = PropertyModel.<String>builder().codec(new StringCodecExt()).build();
    }
