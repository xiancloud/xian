...
public class PatternUtil {
     ...
     * 得到{}扩住的key，并一律转为驼峰式
     */
    protected static List<String> getCamelKeys(String pattern) {
        List<String> keys = new ArrayList<String>();
    ...
    protected static List getValues(String sqlPattern, Map map) {
    ...
    protected static List getValues(List<String> camelKeys, Map map) {
    ...
    //兼容{}内出现下划线的情况
    protected static String bareError(String pattern) {
    ...
    protected static void adjustLikeClause(String pattern, Map map) {
