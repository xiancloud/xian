package info.xiancloud.plugin.dao.core.jdbc;
...
public class BasicSqlBuilder {
    ...
    public static Pair<String, Object[]> buildBatchInsertPreparedSQL(String tableName, String[] cols, List<Map> dataList) {
    ...
    private static Set<String> findValidCols(String[] allCols, List<Map> dataList) {
